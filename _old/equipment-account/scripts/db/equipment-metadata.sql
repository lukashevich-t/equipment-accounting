...
CREATE TABLE `equipment_state` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Справочник состояний объектов инвентаризации';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `equipment_type` (
  ...
  `name` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Справочник типов объектов инвентаризации';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `responsible_person` (
  ...
  `name` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Ответственные лица';
/*!40101 SET character_set_client = @saved_cs_client */;
